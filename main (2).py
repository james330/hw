...
while True:     #持續輸入。輸入 s以開始讀取組合語言， c以結束
    code=input("input: ")
    ...
    if code == "s":     #如果輸入為 s，代表可以開始輸入程式
        ...
        while True:
            ...
            if len(st) == 1:
                if Assembly_Mnemonic.get(st[0]) == None:
            ...
            elif len(st) == 2:        #如果字串分割後只有兩個，及只有 opcode和 oprand的話
...
if num_of_ch<=len_of_ch:
    while True:     
        if len_of_ch <= num_of_ch:      
            ...
            if len(part_of_ch) == 3:      
                while True:
                    if part_of_ch[1] =="START":
                        print("H" ,end='')
                        print(part_of_ch[0] ,end=' ')

                        if len(part_of_ch[2]) ==3:
                            print("000" ,end='')
                        if len(part_of_ch[2]) ==4:
                            print("00" ,end='')
                        if len(part_of_ch[2]) ==5:
                            print("0" ,end='')
                        if len(part_of_ch[2]) ==6:
                            print("" ,end='')
                        
                        print(part_of_ch[2] ,end='')
